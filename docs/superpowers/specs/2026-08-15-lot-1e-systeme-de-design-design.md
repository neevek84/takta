...
Une seule source, exposée en variables CSS et consommée par Tailwind. Aucune couleur en dur dans un composant : une valeur écrite à la main est une valeur qu'on ne pourra pas changer.
...
## 7. L'application aux écrans existants
...
- **Marque blanche** ou personnalisation des couleurs par l'utilisateur.
